...
public class KafkaConfig {
    ...
    Map<String, Object> producerConfig(){
        ...
        // Add the default replication factor for topics
        config.put("spring.kafka.admin.default-topic-replication-factor",
                environment.getProperty("spring.kafka.admin.default-topic-replication-factor", "1"));
        return config;
    }
